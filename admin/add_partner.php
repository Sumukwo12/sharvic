...
<head>
    ...
    <title>Add Partner - Sharvic East Africa Limited</title>
        ...
        <div class="main-content">
            ...
            <?php if ($success): ?>
                <div class="alert alert-success">
                    Partner added successfully! <a href="partners.php">Go back to partners</a>
                </div>
            <?php endif; ?>
            ...
            <div class="content-box">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <small style="color: #666; display: block; margin-top: 5px;">Recommended size: 200x100 pixels. Max file size: 1MB.</small>
                    </div>
