...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO projects (title, client, description, status, image) VALUES (?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssss", $title, $client, $description, $status, $new_filename);
...
<head>
    ...
    <title>Add Project - Sharvic East Africa Limited</title>
        ...
        <div class="main-content">
            ...
            <?php if ($success): ?>
                <div class="alert alert-success">
                    Project added successfully! <a href="projects.php">Go back to projects</a>
                </div>
            <?php endif; ?>
            ...
            <div class="content-box">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="client" name="client" class="form-control" value="<?php echo isset($_POST['client']) ? htmlspecialchars($_POST['client']) : ''; ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="status" name="status" class="form-control" required>
                            ...
                            <option value="Completed and in Use" <?php echo (isset($_POST['status']) && $_POST['status'] == 'Completed and in Use') ? 'selected' : ''; ?>>Completed and in Use</option>
                        </select>
                    </div>
