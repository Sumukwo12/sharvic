...
if (isset($_GET['delete'])) {
    ...
    $imageQuery = "SELECT image FROM projects WHERE id = $id";
    ...
    if ($conn->query($deleteQuery) === TRUE) {
        ...
        $deleteError = "Error deleting project: " . $conn->error;
    }
}
...
<head>
    ...
    <title>Manage Projects - Sharvic East Africa Limited</title>
        ...
        <div class="main-content">
            ...
            <div class="content-box">
                <div class="content-header">
                    <h3>All Projects</h3>
                    <a href="add_project.php" class="btn"><i class="fas fa-plus"></i> Add New Project</a>
                </div>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<a href='edit_project.php?id=" . $row["id"] . "' class='btn btn-warning'><i class='fas fa-edit'></i> Edit</a>";
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                confirmBtn.href = `projects.php?delete=${projectId}`;
